...
var flags = ['nope', 'noBranch', 'noDistinct', 'noQvars',
...
function Eye(options) {
  ...
  eye.eyePath = options.eyePath || /^win/.test(process.platform) ? 'eye.cmd' : 'eye';
...
Object.defineProperty(Eye, 'flags', { value: flags });
Object.defineProperty(Eye, 'flagNames', { value: flags });
